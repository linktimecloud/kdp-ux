...
const getEnv = (key, defaultVal) => process.env[`VUE_APP_${key}`] || defaultVal

const supportedLangs = SUPPORTED_LANG_LIST()
const lang = getEnv('DEFAULT_LANG') || (navigator.language || navigator.userLanguage || 'zh').substr(0, 2)
...
export const API_BASE = getEnv('API_BASE')
