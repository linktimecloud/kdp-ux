...
import SystemAppsList from '@/pages/apps/catalogHomepage/systemAppsList/index.vue'
import AppsList from '@/pages/apps/catalogHomepage/appsList/index.vue'
import InstallList from '@/pages/apps/catalogHomepage/installList/index.vue'
import AppInstruction from '@/pages/apps/catalogHomepage/appInstruction/index.vue'
